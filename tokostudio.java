public class tokostudio {
    public static void main(String[] args) {
        ...
        // a. Banyaknya tiket terjual pada setiap cabang secara harian
        ...
        for (int i = 0; i < penjualanTiket15.length; i++) {
            ...
            for (int j = 0; j < penjualanTiket15[i].length; j++) {
                ...
                totalTiket += penjualanTiket15[i][j];
            }
            System.out.println("Total tiket: " + totalTiket + "\n");
        }

        // b. Total penjualan tiket berdasarkan weekdays dan weekend
        ...
        // c. Total pemasukan bioskop selama seminggu
        ...
        // d. Jenis studio dan nama hari dengan pen
...
sebelum output total pemasukan bioskop selama seminggu tambahkan rata rata penjualan tiket dalam satu hari yaitu pada hari selasa