public class tokostudio22 {
        public static void main(String[] args) {
            ...
            // Rata-rata penjualan tiket dalam satu hari pada hari Selasa (indeks 1)
            int totalPenjualanSelasa = 0;
            for (int i = 0; i < penjualanTiket15.length; i++) {
                totalPenjualanSelasa += penjualanTiket15[i][1]; // Mengakumulasi penjualan tiket pada hari Selasa
            }
            double rataRataSelasa = (double) totalPenjualanSelasa / penjualanTiket15.length;
    
            System.out.println("Rata-rata penjualan tiket dalam satu hari pada hari Selasa: " + rataRataSelasa);
    
            int totalPemasukan15 = 0;
            for (int i = 0; i < penjualanTiket15.length; i++) {
                for (int j = 0; j < penjualanTiket15[i].length; j++) {
                    totalPtotalPemasukan15 += penjualanTiket15[i][j] * hargaTiket15[i][j % 2];
                }
                }
